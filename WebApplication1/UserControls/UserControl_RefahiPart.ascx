<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserControl_RefahiPart.ascx.cs" Inherits="WebApplication1.UserControls.UserControl_RefahiPart" %>
...
<style>
  ...
  <div class=" container-fluid" style="direction:rtl;">
          ...
          <div class="table table-borderless ">
        <asp:DataList ID="DataList1"  runat="server" CellSpacing="1" CellPadding="1" Style="font-family: 'B Mitra'; direction:rtl;" RepeatColumns="3" Width="100%" RepeatLayout="Table" DataKeyField="ID" OnItemDataBound="ListLabs_ItemDataBound" RepeatDirection="Horizontal" >
            <ItemTemplate >
