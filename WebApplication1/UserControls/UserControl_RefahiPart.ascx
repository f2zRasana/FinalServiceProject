...
<div class=" container-fluid" style="direction: rtl;">
    ...
    <div class="table table-borderless ">
        <asp:DataList ID="ListRef" runat="server" CellSpacing="1" CellPadding="1" Style="font-family: 'B Mitra'; direction: rtl;" RepeatColumns="3" Width="100%" RepeatLayout="Table" DataKeyField="ID" OnItemDataBound="ListRef_ItemDataBound" RepeatDirection="Horizontal">
            <ItemTemplate>
